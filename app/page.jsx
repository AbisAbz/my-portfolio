      ...
      <div className="container mx-auto h-full justify-center">
        <div className="flex flex-col xl:flex-row  justify-between items-center xl:pt-8 xl:pb-16">
          <div className="text-center xl:text-left order-2 xl:order-none ">
            ...
            <h1 className="h2 mb-6">Hi I'm <br /><span className="text-accent">ABIS V</span></h1>
            <p className="max-w-[500px] mb-9">
   🚀 I specialize in crafting and developing 👨‍💻 seamless digital solutions with a passion for innovation and user-centric design. 🌟 With expertise in modern programming languages and  technologies. ✨
</p>
